...
VALUES
    (1, 'Mahindra', 'Bangalore'),
    (2, 'Aquity Solutions', 'Mumbai'),
    (3, 'InfoTech Innovators', 'Hyderabad'),
    (4, 'Slumberger', 'Chennai'),
    (5, 'Infosys Technologies', 'Pune'),
    (6, 'SoftwareSolutions Ltd', 'Delhi'),
    (7, 'Edutech Solutions', 'Kolkata'),
    (8, 'Mindtree Innovations', 'Ahmedabad'),
    (9, 'Urjent Solutions', 'Jaipur'),
    (10, 'HealthCare Systems', 'Chandigarh');

-- Insert data into Jobs table
    INSERT INTO Jobs 
VALUES
    (1, 1, 'Android Developer', 'Develop Android applications', 'Bangalore', 90000.00, 'Full-time', '2023-02-01 08:00:00'),
    ...
    (10, 5, 'Java Developer', 'Develop Java applications', 'Pune', 90000.00, 'Full-time', '2023-02-10 19:15:00');

-- Insert data into Applicants table
    INSERT INTO Applicants 
VALUES
    (1, 'Sneha', 'Palani', 'sneha.palani@email.com', '123-456-7890', 'Resume for Sneha Palani', 7),
    (2, 'Priya', 'Sharma', 'priya.sharma@email.com', '987-654-3210', 'Resume for Priya Sharma', 5),
    (3, 'Pal', 'Singh', 'pal.singh@email.com', '345-678-9012', 'Resume for Pal Singh', 6),
    (4, 'Sam', 'Gupta', 'sam.gupta@email.com', '567-890-1234', 'Resume for Sam Gupta', 8),
    (5, 'Sachin', 'Patil', 'sachin.patil@email.com', '789-012-3456', 'Resume for Sachin Patil', 9),
    (6, 'Selvi', 'Mehta', 'selvi.mehta@email.com', '901-234-5678', 'Resume for Selvi Mehta', 4),
    (7, 'Arun', 'Nayar', 'arun.nayar@email.com', '234-567-8901', 'Resume for Arun Nayar', 6),
    (8, 'Swati', 'Poorna', 'swati.poorna@email.com', '456-789-0123', 'Resume for Swati Poorna', 5),
    (9, 'Raj', 'Kumar', 'raj.kumar@email.com', '678-901-2345', 'Resume for Raj Kumar', 7),
    (10, 'Rufus', 'Santosh', 'rufus.santosh@email.com', '890-123-4567', 'Resume for Rufus Santosh', 8);

-- Insert data into Applications table
	INSERT INTO Applications 
VALUES
    (1, 1, 1, '2023-02-03 12:45:00', 'Cover letter for Android Developer from Sneha Palani'),
    (2, 1, 2, '2023-02-04 14:20:00', 'Cover letter for UX/UI Designer from Priya Sharma'),
    (3, 2, 3, '2023-02-05 15:30:00', 'Cover letter for Business Analyst from Pal Singh'),
    (4, 2, 4, '2023-02-06 16:45:00', 'Cover letter for iOS Developer from Sam Gupta'),
    (5, 3, 5, '2023-02-07 18:00:00', 'Cover letter for Data Scientist from Sachin Patil'),
    (6, 3, 6, '2023-02-08 19:15:00', 'Cover letter for Network Engineer from Selvi Mehta'),
    (7, 4, 7, '2023-02-09 20:30:00', 'Cover letter for Software Tester from Arun Nayar'),
    (8, 4, 8, '2023-02-10 21:45:00', 'Cover letter for Technical Writer from Swati Poorna'),
    (9, 5, 9, '2023-02-11 23:00:00', 'Cover letter for Project Coordinator from Raj Kumar'),
    (10, 5, 10, '2023-02-12 01:15:00', 'Cover letter for Java Developer from Rufus Santosh');
...
-- NOTE : Adding Experience column, because we dont find it in the schema. 
...
NOTE: Adding city and state, because we dont find it in the Schema. */
